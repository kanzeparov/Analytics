...
function firstMessage(ctx) {
    ...
    finalResult = "⚔️⚔️$AWW. games official airdrop bot$⚔️⚔️"
    finalResult += "\n"
    finalResult += "\n"
    finalResult += "⚠️Please note, that you can only be eligible for the AIRDROP if you fulfill ALL the actions below⚠️"
    finalResult += "\n"
    finalResult += "\n"
    finalResult += "For special bounties (eg. Telegram stickers, Telegram staking calculator bot, or any other unique idea) please contact  @AwwGames"
    finalResult += "\n"
    finalResult += "\n"
    finalResult += "To claim your tokens you need to:"
    finalResult += "\n"
    finalResult += "1.📌Follow us on Twitter: https://twitter.com/AwwGames"
    finalResult += "\n"
    finalResult += "2.📌Join our announcement channel: https://t.me/aww_announcement"
    finalResult += "\n";
    finalResult += "3.📌Join our official group: https://t.me/joinchat/DP_YTlbE0GPdNS_913EB1A"
    finalResult += "\n";
    finalResult += "4. Click the buttons and input the required data, after that click CONFIRM✅";
...
function makeMessage(ctx) {
    var finalResult;
    finalResult = "⚔️⚔️Welcome to AWW airdrop bot (Aww.games)!⚔️⚔️"
    finalResult += "\n"
    finalResult = "👤ID: "
    ...
    finalResult += "\n";
    finalResult += "💰Referral link: https://t.me/AwwGamesAirdropFreeBot?start=";
...
bot.action('eth', (ctx) => { //button click ETH
    ...
    var msg = "🤩Input your ERC-20 compatible Ethereum address";
    ctx.telegram.sendMessage(ctx.from.id, msg, Extra.markup(keyboard))
    ctx.session.step = 1;
});

bot.action('twitter', (ctx) => { //button click twitter
    var msg = "🤩Input Twitter username";
    ctx.telegram.sendMessage(ctx.from.id, msg, Extra.markup(keyboard))
    ctx.session.step = 2;
});
...
// bot.action('information', (ctx) => { //button click refresh data
//     var msg = ctx.session.refNumber;
//     tx.reply(msg);
// });
...
bot.action('confirm', (ctx) => {
    ...
    var msg;
    msg = "🤩We will check your entry.\n\n📌Channel: https://t.me/aww_announcement\n📌Group: https://t.me/joinchat/DP_YTlbE0GPdNS_913EB1A\n📌Twitter: https://twitter.com/AwwGames";
    msg += "\n\n";
    msg += "Please use this referral link";
    msg += "\n";
    msg += "https://t.me/AwwGamesAirdropFreeBot?start=";
